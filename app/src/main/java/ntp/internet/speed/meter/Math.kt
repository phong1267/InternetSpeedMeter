...
class Math {
    ...
    fun main() {
        ...
        toDoNextDay()   // Dùng để reset dât về 0 mỗi khi qua ngày mới
        mathSumSpeed()
    }
    ...
    fun getDate(): Int = Calendar.getInstance().get(Calendar.DATE)
    ...
    fun getSpeedInternet() {
        //Lưu ý rằng các số liệu thống kê được trả về bởi lớp này thiết lập lại và bắt đầu từ số 0 sau mỗi lần khởi động lại.
        var downloadSpeed = getTotalRxBytes()
        var upLoadSpeed = getTotalTxBytes()
        Thread.sleep(1000)
